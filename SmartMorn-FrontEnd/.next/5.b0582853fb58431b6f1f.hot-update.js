...
/* harmony default export */ __webpack_exports__["b"] = (function () {
  ...
  switch (action.type) {
    case ACTION_AUTH.LOGIN:
      console.log(__WEBPACK_IMPORTED_MODULE_1__utils_api__["a" /* default */]); // axios.get('/user/login').then((resp) => {
      //     console.log(resp);
      // }).catch((error) => {
      //     console.log(e)
      // });
...
//# sourceMappingURL=5.b0582853fb58431b6f1f.hot-update.js.map