  ...
  _createClass(Register, [{
    ...
    value: function register(e) {
      ...
      if (this.state.password != this.state.confirmPassword) {
        console.log('work');
        this.setState(_objectSpread({}, state) // errorMessageNotMatch: "Password Not match"
        );
      }
    ...
    value: function render() {
      ...
      }, this.state.errorMessageNotMatch), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(FormWithMargin, {
        method: "post",
...
//# sourceMappingURL=9.7d0df92a1f7fc713caca.hot-update.js.map